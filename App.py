...
from_currency = st.selectbox("From_currency:",options=list(currency_to_country.keys()))
...
to_currency = st.selectbox("To_currency:",options=list(currency_to_country.keys()))
